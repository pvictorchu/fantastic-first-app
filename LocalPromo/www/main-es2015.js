...
const routes = [
    ...
    {
        path: 'nova-senha',
        loadChildren: () => __webpack_require__.e(/*! import() | nova-senha-nova-senha-module */ "nova-senha-nova-senha-module").then(__webpack_require__.bind(null, /*! ./nova-senha/nova-senha.module */ "./src/app/nova-senha/nova-senha.module.ts")).then(m => m.NovaSenhaPageModule)
    },
    {
        path: 'feed',
        loadChildren: () => Promise.all(/*! import() | feed-feed-module */[__webpack_require__.e("default~feed-feed-module~perfil-perfil-module"), __webpack_require__.e("common"), __webpack_require__.e("feed-feed-module")]).then(__webpack_require__.bind(null, /*! ./feed/feed.module */ "./src/app/feed/feed.module.ts")).then(m => m.FeedPageModule)
    },
    {
        path: 'perfil',
        loadChildren: () => Promise.all(/*! import() | perfil-perfil-module */[__webpack_require__.e("default~feed-feed-module~perfil-perfil-module"), __webpack_require__.e("perfil-perfil-module")]).then(__webpack_require__.bind(null, /*! ./perfil/perfil.module */ "./src/app/perfil/perfil.module.ts")).then(m => m.PerfilPageModule)
    },
    {
        path: 'cadastro',
        loadChildren: () => __webpack_require__.e(/*! import() | cadastro-cadastro-module */ "cadastro-cadastro-module").then(__webpack_require__.bind(null, /*! ./cadastro/cadastro.module */ "./src/app/cadastro/cadastro.module.ts")).then(m => m.CadastroPageModule)
    },
    {
        path: 'chat',
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | visualizacaoChat-visualizacaoChat-module */ "visualizacaoChat-visualizacaoChat-module").then(__webpack_require__.bind(null, /*! ./visualizacaoChat/visualizacaoChat.module */ "./src/app/visualizacaoChat/visualizacaoChat.module.ts")).then(m => m.VisualizacaoChatPageModule)
    }
];
...
module.exports = __webpack_require__(/*! C:\Users\Paulo Victor\Desktop\Projeto Ionic\fantastic-first-app\LocalPromo\src\main.ts */"./src/main.ts");
