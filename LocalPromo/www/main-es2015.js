...
const routes = [
    ...
    {
        path: 'feed',
        loadChildren: () => Promise.all(/*! import() | feed-feed-module */[__webpack_require__.e("common"), __webpack_require__.e("feed-feed-module")]).then(__webpack_require__.bind(null, /*! ./feed/feed.module */ "./src/app/feed/feed.module.ts")).then(m => m.FeedPageModule)
    },
    {
        path: 'perfil',
    ...
    {
        path: 'cadastro',
        loadChildren: () => Promise.all(/*! import() | cadastro-cadastro-module */[__webpack_require__.e("common"), __webpack_require__.e("cadastro-cadastro-module")]).then(__webpack_require__.bind(null, /*! ./cadastro/cadastro.module */ "./src/app/cadastro/cadastro.module.ts")).then(m => m.CadastroPageModule)
    },
    {
        path: 'chat',
...
/* harmony import */ var _ionic_native_camera_preview_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ionic-native/camera-preview/ngx */ "./node_modules/@ionic-native/camera-preview/__ivy_ngcc__/ngx/index.js");
...
module.exports = __webpack_require__(/*! /home/venancio/Documents/projetoN2/fantastic-first-app/LocalPromo/src/main.ts */"./src/main.ts");
