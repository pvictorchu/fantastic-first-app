(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["view-view-module"], {
    ...
    function srcAppPerfilViewViewPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_photos_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/app/services/photos.service */
      "./src/app/services/photos.service.ts");

      var ViewPage = /*#__PURE__*/function () {
        function ViewPage(route, photosService) {
      ...
      ViewPage.ctorParameters = function () {
        return [{
          ...
          type: src_app_services_photos_service__WEBPACK_IMPORTED_MODULE_3__["PhotosService2"]
        }];
      };
