...
/* harmony import */ var _feed_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./feed.page */ "./src/app/feed/feed.page.ts");
...
/* harmony import */ var _feed_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./feed-routing.module */ "./src/app/feed/feed-routing.module.ts");
/* harmony import */ var _feed_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./feed.page */ "./src/app/feed/feed.page.ts");
/* harmony import */ var _components_photo_card_photo_card_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/photo-card/photo-card.component */ "./src/app/components/photo-card/photo-card.component.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".story-avatar {\n  width: 3.25em;\n  height: 3.25em;\n  border: 2px solid orange;\n}\n\n.perfil-icon {\n  border: 2px solid #00eeff;\n  width: 3em;\n  height: 3em;\n}\n\n.avatar {\n  padding: 8px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let FeedPage = class FeedPage {
    ...
    ngOnInit() {
        if (!this.auth.isLoggedIn)
            ...
            this.db.collection('/feed/').snapshotChanges().subscribe(res => {
                console.log(res);
                res.forEach(c => {
                    this.photos.push(Object.assign({ originalid: c.payload.doc.id }, c.payload.doc.data()));
                });
...
FeedPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-feed',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./feed.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/feed/feed.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./feed.page.scss */ "./src/app/feed/feed.page.scss")).default]
    })
], FeedPage);
